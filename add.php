...
$connect  = new mysqli($server, $user, $password, $db);
    ...
    if ( $_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sk_izin_opoprasional        = $_POST["sk_izin_operasional"];
        ...
        do{
            if (empty($npsn) || empty($status) ||empty($bentuk_pendidikan) || empty($nama_sekolah) ||empty($sk_izin_pendirian) || empty($tgl_izin_pendirian) || empty($sk_izin_opoprasional) ||empty($tgl_izin_oprasional) || empty($alamat) || empty($rt) || empty($rw) || empty($dusun) ||empty($desa) || empty($kecamatan) || empty($kabupaten) || empty($provinsi)|| empty($kode_pos)){
            ...
            $sql = "INSERT INTO tabel_siswa (npsn, status, bentuk_pendidikan, nama_sekolah, sk_pendirian, tgl_pendirian, sk_izin_operasional, tgl_izin_operasional, alamat, rt, rw, dusun, desa, kecamatan, kabupaten, provinsi, kode_pos)"
  ...
  <div class="col-sm-6">
        <form method="post">
          ...
          <div class="row mb-3">
              ...
              <div class="col-sm-6">
                  <input type="date" class="form-control" name="tgl_pendirian" value="<?php echo $tgl_izin_pendirian; ?>">
              </div>
          </div>
          <div class="row mb-3">
              <label class="col-sm-3 col-form-label">SK Izin Operasional</label>
              <div class="col-sm-6">
                  <input type="text" class="form-control" name="sk_izin_operasional" value="<?php echo $sk_izin_opoprasional; ?>">
              </div>
          </div>
          <div class="row mb-3">
              <label class="col-sm-3 col-form-label">Tanggal Izin Operasional</label>
              <div class="col-sm-6">
                  <input type="date" class="form-control" name="tgl_izin_operasional" value="<?php echo $tgl_izin_oprasional; ?>">
              </div>
          </div>
