...
<body>
    <div class="container m-3">
        <h2>Data Sekolah</h2>
        <a class="btn btn-primary" href="/ujiansemster/add.php" role="button">Tambah Sekolah</a>
        <br>
            ...
            while($row = $result->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class='btn btn-primary btn-sm' href='/ujiansemster/edit.php?npsn=$row[npsn]'>Edit</a>  
                    </td>
                    <td>
                        <a class='btn btn-dark btn-sm' href='/ujiansemster/delete.php?npsn=$row[npsn]'>Delete</a>
                    </td>
              </tr>
                ";
            }
